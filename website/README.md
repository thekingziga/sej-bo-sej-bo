...
```bash
cd /home/pidocker/docker_image_maker/sejbosejbo && docker build -t thekingziga/sejbosejbo:1.4.0 -t thekingziga/sejbosejbo:latest .
```

```bash
docker login && docker push thekingziga/sejbosejbo:1.4.0 && docker push thekingziga/sejbosejbo:latest
```
...
docker buildx build --platform linux/amd64,linux/arm64 -t thekingziga/sejbosejbo:latest -t thekingziga/sejbosejbo:1.4.0 --push .
```
